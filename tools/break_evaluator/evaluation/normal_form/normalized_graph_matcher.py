...
from graph import get_graph_levels

from normal_form.normalization_rules import prepare_node
import normal_form.normalization_rules as norm_rules
import normal_form.operations_normalization_rules as op_norm_rules
from qdmr_to_program import QDMROperation
### CHANGE START ###
os.chdir(cwd)
### CHANGE END ###
