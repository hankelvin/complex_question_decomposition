...
import unicodedata
### CHANGE START ###
from retrieval.datasets import make_2wiki_musique_like, add_single_hop_musique_2wiki
### CHANGE END ###
...
class MHReaderDataset(Dataset):
    ...
    def __init__(self, 
        ...
        self.sq_all_paragraphs  = sq_all_paragraphs
        if self.do_single_hop:
            if self.dataset_type == 'hotpot': 
                raise NotImplementedError
            elif self.dataset_type in ['musique', '2wiki']:
                self.data = add_single_hop_musique_2wiki(self.data, self.dataset_type, self.sq_all_paragraphs)
        ### CHANGE END ###
    ...
    def __getitem__(self, index):
        ...
        res = {
            ...
            "start_pos": start_pos,
            "end_pos": end_pos,
            "id": sample['id'] if self.dataset_type in ['musique', '2wiki'] else sample['_id'],
            "answer": answer
