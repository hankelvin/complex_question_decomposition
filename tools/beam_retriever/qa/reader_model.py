...
class Reader(nn.Module):
    ...
    def __init__(self, config, model_name, task_type = 'hotpot', 
                 len_tokenizer = 0, gradient_checkpointing = False):
        super().__init__()
    ...
    def forward(
        ...
        if answer_type is not None:
            ...
            loss_func = CrossEntropyLoss()
            ### CHANGE START 
            # answer_type is not on gpu
            output_answer_type = output_answer_type.to(device)
