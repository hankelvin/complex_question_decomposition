...
def train_args():
    ...
    ### CHANGE START ###
    parser.add_argument("--do_single_hop", default = 'False', type = str, 
                        help = "Whether to include single hop examples in the training data")
    parser.add_argument("--sq_all_paragraphs", default = 'False', type = str, 
                        help = "Whether to include all paragraphs in the single hop QA examples")
    args = parser.parse_args()
    args.do_single_hop = eval(args.do_single_hop)
    args.sq_all_paragraphs = eval(args.sq_all_paragraphs)
    ### CHANGE END ###
    return args
