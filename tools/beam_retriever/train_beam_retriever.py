...
def main():
    ...
    if args.use_flash_attention:
        bert_config.use_memory_efficient_attention = True
    ...
    model = Retriever(bert_config, args.model_name, AutoModel,
                      ...
                      gradient_checkpointing=args.gradient_checkpointing, use_label_order=(args.dataset_type in ['musique', '2wiki']))
    
    ### CHANGE START ###
    eval_dataset = HotpotQADataset(tokenizer, args.predict_file, args.max_seq_len, 
                                   dataset_type = args.dataset_type, 
                                   do_single_hop = args.do_single_hop)
    ### CHANGE END ###
    ...
    if args.do_train:
        ...
        ### CHANGE START ###
        train_dataset = HotpotQADataset(tokenizer, args.train_file, args.max_seq_len, 
                                        dataset_type = args.dataset_type, 
                                        do_single_hop = args.do_single_hop,)
        ### CHANGE END ###
        if args.local_rank != -1:
